...
tags:
  - EDyAII
---
# Def. de funciones suaves y usos
## La idea en una oración
---
> Una función $f(n)$ es *suave* si es eventualmente no decreciente y si $f(bn) \in O(f(n))$ Permite facilitar la demostración de notaciones asintóticas
## Desarrollo
---
